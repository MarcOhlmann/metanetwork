...
![plot of chunk distrib TL](figure/distrib TL-1.png)
...
![plot of chunk distrib TL](figure/distrib TL-2.png)
...
![plot of chunk SBM level](figure/SBM level-1.png)
...
![plot of chunk SBM level 2](figure/SBM level 2-1.png)
...
![plot of chunk TL-tsne species](figure/TL-tsne species-1.png)![plot of chunk TL-tsne species](figure/TL-tsne species-2.png)
...
![plot of chunk group config](figure/group config-1.png)

```r
net_group_layout3
```

![plot of chunk group config](figure/group config-2.png)
...
![plot of chunk mammals](figure/mammals-2.png)
