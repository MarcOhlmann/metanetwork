...
```{r distrib_TL,fig.height = 8, fig.width = 8}
...
```{r compo,fig.height = 8, fig.width = 8}
TL_df_mean = TL_df %>% 
...
```{r SBM_level,fig.height = 8, fig.width = 8}
beta = 0.005
...
The size of the symbols is proportional to group relative abundances.
To compute layout for another $\beta$ value, you can do:
```{r SBM_level_2,fig.height = 8, fig.width = 8}
beta = 0.0035
...
```{r SBM_level_3,fig.height = 8, fig.width = 8}
...
```{r TL-tsne_species,fig.height = 8, fig.width = 8}
beta = 4e-06
...
## Playing on representation parameters 
...
```{r group_config,fig.height = 8, fig.width = 8}
beta = 0.0035
...
```{r grid,fig.height = 8, fig.width = 8}
